          ...
          children: permissions.map((permission) {
            return LayoutBuilder(
              builder: (context, constraints) {
                // Kiểm tra kích thước màn hình để điều chỉnh chip
                final isSmallScreen = MediaQuery.of(context).size.width <= 600;
      ...
      child: Column(
        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              if (isSmallScreen) {
                // Hiển thị nút dạng full-width cho mobile
                return Column(
                  children: [
                    SizedBox(
                ...
                // Hiển thị nút dạng inline cho desktop
                return Row(
          ...
          : LayoutBuilder(
              builder: (context, constraints) {
                ...
                if (constraints.maxWidth > 600) {
                  ...
                  return Column(
                    children: [
                      // Phần header với các nút chức năng
                      Padding(
                        padding: const EdgeInsets.all(16.0),
                        child: Row(
                      ...
                      // Form chỉnh sửa vai trò (phần dưới)
                      Expanded(
                        child: SingleChildScrollView(
                          padding: const EdgeInsets.all(16.0),
                          child: _buildRoleForm(),
